...
//     const analysisText = (await analysisResponse.response.text()) || "{}";
...
//     const finalText = (await responseResult.response.text()) || "I'm here to help.";

//     logger.info("Generated response:", finalText);
...
//         analysis,
//         progress: {
//           emotionalState: analysis.emotionalState || "unknown",
...
//     const { sessionId } = req.params;
//     const userId = new Types.ObjectId(req.user.id);
//     const session = (await ChatSession.findOne({ sessionId, userId })) as
//       | IChatSession
//       | null;
